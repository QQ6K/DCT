...
Это учебный MVP-проект, моделирующий систему мониторинга для собаки.
...
Значения показателей это время в часах.
...
Можно без id в Dog и dog_id в DogLog, но не будем экономить на спичках.
