...
Так как проект учебный и не использует фоновые процессы, время моделируется вручную. Каждый час собака чуть-чуть голодает, чуть-чуть устает, чуть-чуть хочет воды.
...
Слой взаимодействия с пользователем. Вероятно один модуль/файл. Разбивать на классы, наверно, тоже не имеет смысла. Уже достаточно промышленной ярости разделить на слои.
